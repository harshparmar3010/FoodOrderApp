...
<html>
<head>
<jsp:include page="include/meta_tag_holder.jsp" />
<title>Access Denied</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/403PageStyle.css">
</head>
<body>
	...
	<h2>
		Go <a target="_blank" href="/">Home!</a>
	</h2>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/403Page.js"></script>
</body>
</html>