...
<body>
	...
	<form method="post"
		<c:if test="${ action eq 'add' }">action="/restaurant/offers/add"</c:if>
		<c:if test="${ action eq 'edit' }">action="/restaurant/offers/edit"</c:if>>
		...
		<div class="form-group mb-3">
			<label class="fw-bold" style="color: #636469;" for="offerName">Offer Name</label> 
			<div class="input-group">
				<span class="input-group-text" id="inputGroupPrepend"><i class="fa-solid fa-lightbulb"></i></span>
				<input type="text"
				class="form-control" name="name" placeholder="Offer Name" data-textRequired
				required data-textRequired-error="Offer name must contain only letters, numbers, underscores, hyphens, and spaces. It cannot start or end with a space."
		...
		<div class="form-group mb-3">
			<label class="fw-bold" style="color: #636469;" for="discount">Discount(%)</label>
			<div class="input-group">
